...
def main():
    ...
    with open(input_file, 'r') as f:
        ...
        if not first_line.startswith('SIMULATION_TYPE 3'):
            print("Il parametro SIMULATION_TYPE non è impostato su 3. Modificare il file di input.")
            return
    ...
    output_dir = '../OUTPUT'
    data_dir = '../../lezione_06/OUTPUT_GIBBS'
