...
private:
  ...
  int _nblocks_salto;     // Number of blocks before starting the measures
  ...
  int _index_temp, _index_pressure;                         // Indices for accessing temperature, pressure, and radial dist. function
  vec _index_gofr;                                          // Vector of indeces for accessing g(r) in each bin 
  ...
  double _global_av_cv, _global_av2_cv; //Global and squared global average of heat capacity
...
public: // Function declarations
  ...
  int get_nblocks_salto();    // Get the number of blocks before the measure
